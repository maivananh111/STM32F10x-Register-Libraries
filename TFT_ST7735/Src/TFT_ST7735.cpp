...
#ifdef USE_EX_FLASH
void TFT_ST7735::WriteRGBBitmapToFlash(W25Q w25q, uint32_t Write_Address, uint16_t w, uint16_t h, const uint16_t *Bitmap){

}

void TFT_ST7735::DrawRGBBitmapInFlash(W25Q w25q, uint32_t Read_Address, uint16_t x, uint16_t y){
